...
$custom_banner = get_post_meta($post_id, '_solution_banner_url', true);
                ...
                <div class="card sidebar-card mb-4 border-0 shadow-sm rounded-3 position-sticky top-25">
                    <div class="card-body p-4">
                        ...
                        <?php
                            ...
                            echo '<p class="text-muted small">No related solutions found.</p>';
                        endif;
                        ?>
...
// Fallback to all partners if specific match has no posts
