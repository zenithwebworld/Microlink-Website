...
/* Responsive Class Add S */
    $( document ).ready(function() {
        $(".menu ul li").find("ul").before('<span class="is-open"><img class="lazy" src="/wp-content/themes/microlink-solutions/assets/images/plus.svg" alt="Menu Close" title="Menu Close" width="20" height="20"></span>');
...
$(function () {
    ...
    function animateCounter(el, from, to, duration) {
        ...
        const suffix = $(el).data('suffix') ?? '+'; // safer default
        ...
        function step(timestamp) {
            ...
            if (progress < 1) {
                ...
                el._rafId = null;
                el._completed = true; // 👈 mark as done
            }
        }
    ...
    const io = new IntersectionObserver(entries => {
        entries.forEach(entry => {
            ...
            $(section).find('.counter-number').each(function () {
                ...
                // ✅ DO NOT re-run if already completed
                if (el._completed) return;
